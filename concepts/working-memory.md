...
ワーキングメモリは、作業中に一時的に情報を保持して操作する力。ADHDの生活工夫では、「頭の中に置き続ける」前提を下げ、[[external-memory]]や[[environment-design]]へ逃がす発想が実用的に扱われている。
...
[[sluggish-cognitive-tempo]]研究では、SCT症状がマインドワンダリングや[[rumination]]に独自に関連することが示され、ADHDの注意・保持困難をすべて同じ機序で読まない必要がある。^[raw/papers/fredrick-2020-sct-adhd-task-unrelated-thought.md]

## 注意点

ここではX/Twitter投稿に出てきた生活工夫の背景概念として整理している。認知機能の評価や治療判断の代替ではない。
