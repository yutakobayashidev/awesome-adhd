...
> Last updated: 2026-08-12 | Total pages: 51
...
- [[attention-control]] — 成人ADHDの課題無関係刺激への弱さを、周囲音の遮断、環境設計、作業負荷、通知制御と接続して扱うページ。
- [[curiosity-reward-memory]] — 好奇心、情報価値、報酬系、記憶の研究を、興味駆動の着手・過集中設計の補助線として扱うページ。
- [[digital-interruptions]] — スマホ通知、メール確認、SNS/ゲーム開始前タイマーなど、注意・時間管理・作業再開へ与えるデジタル割り込みを整理するページ。
...
- [[digital-adhd-support]] — AI、医療機器プログラム、自己管理アプリ、自作集中アプリ、Beeper等のメッセージ統合、AIによる外部記憶・再開支援、診断補助、親支援、学校・職場配慮を、証拠の強さと生活実装に分けて読む入口。
...
- [[careless-mistake-countermeasures]] — ケアレスミスしやすい状況や処理単位を短い確認リスト／動作マニュアルへ外部化し、試験・提出直前の注意負荷を下げる実践。
...
- [[energy-management]] — ADHDバーンアウトや帰宅後シャットダウンを、見える化・タイマー制御・休息予定化・回復コスト見積もりで防ぐ対策。
- [[environment-design]] — 物理配置・透明収納・制服化・固定ゾーン・ドアノブ持ち出し・鍋料理の単工程化などで、記憶や意志力への依存を減らす考え方。
- [[executive-function]] — 着手・優先順位づけ・抑制・切り替え・時間管理を支える実行機能と、その外部化の考え方。
- [[exercise]] — 成人ADHDの実行機能や中核症状に対する運動研究を、非薬物的支援の候補として慎重に整理するページ。
- [[external-memory]] — 紙・スマホ・タイマー・置き場所・状態表示・受信箱・壁打ちトーク・メッセージ統合・自動化・通話相手・AI・断片列に記憶や判断を預け、作業記憶の負荷を下げる考え方。
- [[fear-of-missing-out]] — SNSや通知の見逃し不安を、ADHD支援の有限化・作業復帰・感情調整と接続して整理するページ。
- [[forgetfulness-countermeasures]] — 玄関ランディングパッド、ドアノブ掛け、毎回同じ順序の出発前チェック、透明収納、GPSタグ、ストラップ、施錠確認ツール、書類一箇所化、現地常備などの忘れ物対策。
- [[hyperfocus-control]] — 過集中を自力で止めるのではなく、開始前の終了アラーム、区切り、余白、周囲の声かけで制御する方法。
- [[impulsivity-countermeasures]] — セール通知オフ、保存カード削除、一晩置く、予算先決めなどで衝動が立ち上がる入口を減らし、我慢より環境側の摩擦で支える実践。
...
- [[task-initiation]] — 5秒以内メモ、思いつき受信箱、最初の1動作、AIによる白紙破壊、午前の起動儀式、通話ボディダブリング、AI順序固定、反ポモドーロ調整、ゲーム化などで着手摩擦を下げる方法。
- [[time-management]] — 時間盲・遅刻・過集中に対して、午前3時間固定、開始前の終了アラーム、視覚タイマー、ポモドーロ再着手コスト点検、音声ルーチンタイマー、工程別完了時刻を使う方法。
- [[waiting-mode]] — 後に予定があるだけで前の時間が使えなくなる状態を、時間管理・着手・外部記憶の重なりとして整理するページ。
- [[work-routines]] — 午前固定枠、割込分離、壁打ちトーク投入、AI/チェックリスト、会議後の終了処理、退勤後に頼らない予定、強制休憩合意など、仕事の実行機能を外部化する実践。
