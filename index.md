...
> Last updated: 2026-07-28 | Total pages: 51
...
- [[time-management]] — 時間盲・遅刻・過集中に対して、視覚タイマー、音声ルーチンタイマー、アナログ時計、工程別完了時刻、時間アンカーを使う方法。
- [[waiting-mode]] — 後に予定があるだけで前の時間が使えなくなる状態を、時間管理・着手・外部記憶の重なりとして整理するページ。
- [[work-routines]] — 興味のない仕事や長期仕事を低消耗で通過するための2割以内ルール、手順固定、25分単位化、自動化、週次確認。
